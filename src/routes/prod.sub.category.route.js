...
import { deleteProductSubCategory, getAllProductSubCategories, getProductSubCategory, getProductSubCategoryCount, registerProdSubCategory, updateProductSubCategory } from "../controllers/prod.sub.category.controller.js";
...
subCategoryRouter.get("/sub-category-count", getProductSubCategoryCount);
